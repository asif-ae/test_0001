...
import { getLandingPageContent, getBlogPosts } from "@/lib/payload";
    ...
    <main className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-blue-700 to-indigo-500 text-white text-center py-24">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h1 className="text-6xl font-extrabold leading-tight">{landingPage.heroTitle}</h1>
      ...
      <section className="py-20 px-6 text-center bg-gray-50 dark:bg-gray-800">
        <h2 className="text-4xl font-semibold text-gray-900 dark:text-gray-100">Why Choose Us?</h2>
      ...
      <section className="bg-gray-100 dark:bg-gray-900 py-20 px-6">
        <h2 className="text-4xl font-semibold text-center text-gray-900 dark:text-gray-100">Latest Blog Posts</h2>
        <div className="max-w-5xl mx-auto mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-10">
          {blogPosts.length === 0 ? (
            ...
            blogPosts.map((post: BlogPost) => (
              ...
              >
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{post.title}</h3>
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  <span className="font-semibold">{post.blogName}</span> by {post.author}
                </p>
